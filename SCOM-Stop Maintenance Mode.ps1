...
# Type: New Service
#
# Title: SCOM - Stop SCOM Maintenance Mode
#
...
# Code Template V 1.4
#
# URL: https://au2mator.com/scom-self-service-with-au2mator-stop-maintenance-mode/?utm_source=github&utm_medium=social&utm_campaign=SCOM_StartMM&utm_content=PS1
# Github: https://github.com/au2mator/SCOM-Stop-Maintenance-Mode
...
try {
    ...
    } -ArgumentList  $c_ScomDA, $c_Comment 
    
    Write-au2matorLog -Type INFO -Text "Maintenance Mode stopped"


    $au2matorReturn = "Stopped Maintenance Mode for $c_ScomDA"
    $TeamsReturn= "Stopped Maintenance Mode for $c_ScomDA" #No Special Characters allowed
    $AdditionalHTML = "Stopped Maintenance Mode for $c_ScomDA
        "
    $Status = "COMPLETED"
    ...
    $au2matorReturn = "Failed to stop Maintenance Mode for $c_ScomDA"
    $TeamsReturn= "Failed to stop Maintenance Mode for $c_ScomDA" #No Special Characters allowed
    $AdditionalHTML = "Failed to stop Maintenance Mode for $c_ScomDA
        "
    $Status = "ERROR"
